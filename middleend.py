...
while running:
	...
	#print("- Processing contribs in the last", str(sleep_period), "mins -")
	contribs = []
	...
	if length != 0:
		print( "-", str(length), "wiki contributions made in the last", sleep_period, "mins")	
		
		#print("- Grouping contribs by page titles and authors")
